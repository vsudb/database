...
--                          ROUND(,-2)
--===========================================================================================
--                         Ловушка 1. Перенос кода между СУБД
--===========================================================================================
--                         В PostgreSQL это работает и игнорирует NULL:
--                         SELECT CONCAT('Иванов', ' ', NULL);   -- 'Иванов '
--
--                        -- А в MySQL — вернёт NULL:
--                        SELECT CONCAT('Иванов', ' ', NULL);   -- NULL
--
--                        COALESCE(name, '')
--===========================================================================================
--                         Ловушка 2. || в MySQL — это OR
--===========================================================================================
--                         -- MySQL:
--                         SELECT 'a' || 'b';   -- 1 (TRUE), а не 'ab'!ванов '
--
